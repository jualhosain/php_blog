    ...
    <?php } ?>
                        <ul class='pagination'>
                            <?php
                                ...
                                for($cc=1; $cc<=$page; $cc++){                      
                                    if($cc==$currentPage){
                                        echo "<li class='active'><a href='index.php?page=".$cc."'>".$cc."</a></li>";
                                    }else{
                                        echo "<li><a href='index.php?page=".$cc."'>".$cc."</a></li>";
                                    }
                                }
                                if($currentPage < $page){echo "<li><a href='index.php?page=".($currentPage+1)."'>Next</a></li>";}
                            ?>
                        </ul>
                    </div><!-- /post-container -->
                </div>
